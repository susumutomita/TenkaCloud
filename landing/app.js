(() => {
  ...
  var I18N = {
    ja: {
      ...
      "hero.cta_start": "始める",
      "hero.cta_start_note": "登録不要 · ブラウザだけ · 約 3 分",
      "hero.cta_play": "Codespaces で遊ぶ",
      "hero.cta_host": "自分のイベントを開く",
      "hero.cta_host_note": "AWS アカウント · 課金あり · 約 30 分",
    ...
    en: {
      ...
      "hero.cta_start": "Start",
      "hero.cta_start_note": "No signup · Browser only · ~3 min",
      "hero.cta_play": "Play in Codespaces",
      "hero.cta_host": "Host your own event",
      "hero.cta_host_note": "AWS account · Billed · ~30 min",
