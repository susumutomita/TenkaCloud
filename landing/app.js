(() => {
  ...
  var I18N = {
    ja: {
      ...
      "footer.p0": "概要",
      "footer.p1": "問題カタログ",
      "presentations.kicker": "PRESENTATIONS / 設計と実践の記録",
      "presentations.title": "発表でたどる、TenkaCloudの設計。",
      "presentations.intro":
        "クラウド演習の作り方、運用を任せる境界、暗号を使って学ぶ体験。発表資料と構成図をまとめました。",
      "presentations.jaws.preview": "AWS構成 / 開発の試行錯誤",
      "presentations.jaws.meta": "JAWS-UG横浜 #103 × SRE · 10分 · 日本語",
      "presentations.jaws.title": "GameDayみたいなクラウド演習を自分で作ってみた",
      "presentations.jaws.description":
        "暗号バトルのデモと、クラウド非依存からAWS-nativeへ転換した設計・運用の判断。",
      "presentations.acp.preview": "暗号バトル / 教材設計",
      "presentations.acp.meta": "ACP2026 / FINAL DEMO · 5分 · 日本語",
      "presentations.acp.title": "暗号を「知る」から、暗号で「判断する」へ。",
      "presentations.acp.description":
        "秘密を守るか、公開するか。手計算と対戦をつなぐ暗号バトルのデモ・解説。",
      "presentations.ccoe.preview": "CCoE / クラウド人材育成",
      "presentations.ccoe.meta": "CCoE実践者コミュニティ関西LT · 15分 · 日本語",
      "presentations.ccoe.title": "生成AI時代のCCoEと「作れる」と「出せる」の間にある詰まり",
      "presentations.ccoe.description":
        "TenkaCloud・StackStack・ローカル演習から、CCoEが作る学習導線を考える。",
      "presentations.more": "発表資料の一覧・構成図を見る →",
      "presentations.open": "スライドを見る",
      "presentations.pitch.preview": "StackStack / プロダクト紹介",
      "presentations.pitch.meta": "シンギュラリティ・ソサエティ · 10分 · 日本語",
      "presentations.pitch.title": "クラウドエンジニアの天下一武道会",
      "presentations.pitch.description":
        "AIと作ったアプリをクラウドへ公開し、障害に対処する競技。StackStackの遊び方とTenkaCloudを作るメンバーを紹介します。",
    ...
    en: {
      ...
      "footer.p0": "Overview",
      "footer.p1": "Problems",
      "presentations.kicker": "PRESENTATIONS / DESIGN AND PRACTICE",
      "presentations.title": "Explore TenkaCloud's design through talks.",
      "presentations.intro":
        "Cloud drills, operational boundaries, and learning through cryptography. Browse the slides and architecture diagrams.",
      "presentations.jaws.preview": "AWS architecture / Development lessons",
      "presentations.jaws.meta": "JAWS-UG Yokohama #103 × SRE · 10 min · Japanese",
      "presentations.jaws.title": "Building my own GameDay-style cloud exercises",
      "presentations.jaws.description":
        "A cryptography battle demo and the decisions behind moving from cloud-agnostic infrastructure to AWS-native services.",
      "presentations.acp.preview": "Cryptography battle / Learning design",
      "presentations.acp.meta": "ACP2026 / FINAL DEMO · 5 min · Japanese",
      "presentations.acp.title": "From knowing cryptography to making decisions with it.",
      "presentations.acp.description":
        "Protect a secret or reveal it? A battle demo connecting hand calculations with competition.",
      "presentations.ccoe.preview": "CCoE / Cloud skills",
      "presentations.ccoe.meta": "CCoE Practitioners Community Kansai LT · 15 min · Japanese",
      "presentations.ccoe.title": "CCoE in the AI era: the gap between building and shipping",
      "presentations.ccoe.description":
        "Designing learning paths with TenkaCloud, StackStack, and local exercises.",
      "presentations.more": "Browse all presentations and diagrams →",
      "presentations.open": "View slides",
      "presentations.pitch.preview": "StackStack / Product introduction",
      "presentations.pitch.meta": "Singularity Society · 10 min · Japanese",
      "presentations.pitch.title": "A tournament for cloud engineers",
      "presentations.pitch.description":
        "Deploy an app built with AI and respond to failures. An introduction to StackStack, how a match works, and the TenkaCloud team.",
