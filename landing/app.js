(() => {
  ...
  var I18N = {
    ...
    en: {
      ...
      "hero.cta_play": "Play first",
      "hero.cta_play_note": "Recommended · No AWS · ~5 min",
      "hero.cta_host": "Host your own event",
      "hero.cta_host_note": "AWS account · Billed · ~30 min",
      "hero.cta_demo": "Try the live demo",
