...
import type { MarketplaceSearchParams, ProblemType, ProblemCategory, DifficultyLevel, CloudProvider } from '@/lib/api/problems';
...
export function ProblemFilters({ filters, onFiltersChange, onReset }: ProblemFiltersProps) {
    ...
    <div className="bg-card border rounded-lg p-4 space-y-4">
      ...
      <div className="space-y-4">
        ...
        <div>
          ...
          <Select
            value={filters.type ?? ''}
            onChange={(e) => handleChange('type', e.target.value as ProblemType)}
          >
        ...
        <div>
          ...
          <Select
            ...
            onChange={(e) => handleChange('provider', e.target.value as CloudProvider)}
          >
            <option value="">すべて</option>
        ...
        <div>
          ...
          <Select
            ...
            onChange={(e) => handleChange('sortBy', e.target.value as MarketplaceSearchParams['sortBy'])}
          >
