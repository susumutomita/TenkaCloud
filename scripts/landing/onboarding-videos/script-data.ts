    ...
    slides: [
      {
        ...
        titleEn: "Play local mode",
        bulletsJa: [
          "AWS なしで本物の問題コンテナを動かす",
          "Docker のあるマシンか Codespaces で起動",
        ],
        bulletsEn: [
          "Real problem containers, no AWS account",
          "Any Docker machine — or Codespaces",
        ],
      },
      {
        badge: "STEP 1",
        durationS: 7.5,
        titleJa: "ローカルモードを起動",
        titleEn: "Start local mode",
        bulletsJa: ["Docker を起動(Codespaces なら不要)", "TenkaCloud リポジトリで make local"],
        bulletsEn: ["Start Docker (skip on Codespaces)", "Run make local in the TenkaCloud repo"],
      },
      {
        badge: "STEP 2",
        durationS: 7.5,
      ...
      },
      {
        badge: "STEP 4",
        durationS: 7,
        titleJa: "そのコマンドがチェックポイント 2 の答え",
        titleEn: "That command is also checkpoint 2's answer",
        bulletsJa: ["Step 1 で打った `make local` をそのまま提出", "別の問題を解く必要はない"],
        bulletsEn: [
          "Submit the `make local` you already typed in Step 1",
          "No extra problem to solve",
        ],
      },
      {
        badge: "STEP 5",
