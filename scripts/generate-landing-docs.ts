 ...
 * guard pattern as scripts/generate-landing-locales.ts.
 *
...
function shell(args: { title: string; slug: string | null; article: string }): string {
  return `<!doctype html>
<!-- Generated by scripts/generate-landing-docs.ts — do not edit by hand.
...
async function main(): Promise<void> {
  ...
  if (check && drift > 0) {
    console.error(
      `landing/docs is stale (${drift} file(s)); run: bun run scripts/generate-landing-docs.ts`,
    );
    process.exit(1);
  }
  console.log(
