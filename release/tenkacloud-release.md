...
# TenkaCloud release candidate 1.5.0
...
| --- | --- | --- |
| Platform | [https://github.com/susumutomita/TenkaCloud](https://github.com/susumutomita/TenkaCloud) — the commit tagged `v1.5.0` | — |
...
- The platform commit of this release is derived from its v1.5.0 tag at publish time (#3024); the manifest lives inside that tree and cannot record it.
