...
# TenkaCloud release candidate 1.6.0
...
| --- | --- | --- |
| Platform | [https://github.com/susumutomita/TenkaCloud](https://github.com/susumutomita/TenkaCloud) — the commit tagged `v1.6.0` | — |
| Problem catalog | [`acc9cfe72c86ec9e6abf9689f52687b8561212d5`](https://github.com/susumutomita/TenkaCloudChallenge/commit/acc9cfe72c86ec9e6abf9689f52687b8561212d5) | — |
...
- The platform commit of this release is derived from its v1.6.0 tag at publish time (#3024); the manifest lives inside that tree and cannot record it.
