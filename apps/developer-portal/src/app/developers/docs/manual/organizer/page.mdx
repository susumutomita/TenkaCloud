...
The organizer MCP endpoint belongs to the Always-On control plane. It is
**not automatically added by the Lite deployment pipeline described on this
page**. The Application Admin Console remains the normal operating surface for
a Lite event.
