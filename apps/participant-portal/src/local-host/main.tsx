...
async function boot(root: HTMLElement): Promise<void> {
  ...
  if (runtime.mode !== "local-host" || runtime.role !== "participant" || runtime.apiBaseUrl !== expected) throw new Error("Invalid competition configuration. No demo or automatic-login fallback is permitted.");
  ...
  createRoot(root).render(<StrictMode><I18nProvider><AppConfigProvider config={config}><BrowserRouter><App config={config} /></BrowserRouter></AppConfigProvider></I18nProvider></StrictMode>);
}
